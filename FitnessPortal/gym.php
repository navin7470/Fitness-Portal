...
<div class="banner" >
  ...
  <div style="display: flex;margin: 4%;">
  	<div style="margin-right: 20%;">
  		<h2 style="color:white;">About GYM </h2>
	  	<p style="color:white;">
    ...
    if(isset($_POST['submit'])){
        ...
        if($query == "fee"){
            ...
            try {
              ...
              //----------------------------------------
              $stmt = $conn->query("SELECT fee FROM FitnessPortal.Department where did = 1");
    	...
    	if($query == "facility"){
            ...
            try {
              ...
              //----------------------------------------
              $stmt = $conn->query("SELECT * FROM FitnessPortal.Facility where did = 1");
