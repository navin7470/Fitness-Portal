...
<div class="banner" >
  <div class="slider" >
      <img src="images/food3.jpg" id="slideImg">
  </div>
  <div class="overlay"> 
    <div id="navdiv">
  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown ">
          <a class="nav-link dropdown-toggle" href="index.php" role="button" data-bs-toggle="dropdown" aria-expanded="true">
    ...
    <div style="display: flex;margin: 4%;">
  	<div style="margin-right: 20%;">
  		<h2 style="color:white;">About Diet </h2>
	  	<p style="color:white;">
	  		We have a spacious with beautiful<br> flooring and a mirror wall for alignment self-checks.
	  		<br>
    ...
    if(isset($_POST['submit'])){
        ...
        if($query == "fee"){
            ...
            try {
              ...
              //----------------------------------------
              $stmt = $conn->query("SELECT fee FROM FitnessPortal.Department where did = 3");
    	...
    	if($query == "facility"){
            ...
            try {
              ...
              //----------------------------------------
              $stmt = $conn->query("SELECT * FROM FitnessPortal.Facility where did = 3");
