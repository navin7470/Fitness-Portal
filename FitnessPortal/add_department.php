...
<body>
    <div class="banner">
        ...
        <div class="content">
            <h2>Enter Following Information for Adding Department!!</h2>
            <div>
                <form style="text-align: center" action="" method="post">
                  <br>
                Enter Department id : <input type = "number" name = "did" required></input> <br>
                Enter Department name : <input type = "text" name = "dname" required></input> <br>
        ...
        <?php
          ...
          if(isset($_POST['submit'])){
            ...
            try {
              ...
              $str =  "INSERT INTO FitnessPortal.Department  VALUES ('$did','$dname','$fee')";
              $conn->exec($str);
